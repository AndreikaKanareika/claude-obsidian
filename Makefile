...
.PHONY: test test-address test-tiling test-boundary test-bm25 test-retrieve \
        test-lock test-concurrent test-mode test-contextual test-vault-root \
        test-auto-commit setup-dragonscale \
...
help:
	...
	@echo "  make test-vault-root  scripts/vault-root.sh resolution tests (shell, hermetic)"
	@echo "  make test-auto-commit scripts/auto-commit.sh tests (shell, hermetic)"
...
test: test-address test-tiling test-boundary test-bm25 test-retrieve test-lock test-concurrent test-mode test-contextual test-vault-root test-auto-commit
	@echo ""
...
test-auto-commit:
	...
	@bash tests/test_auto_commit.sh
